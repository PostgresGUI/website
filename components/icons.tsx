...
export function RocketIcon({ height = 24, width = 24 }: IconProps) {
  return (
    <svg
...
export function DocToRightIcon({ height = 24, width = 24 }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={height}
...
export function SearchCheckIcon({ height = 24, width = 24 }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={height}
...
export function LaptopIcon({ height = 24, width = 24 }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={height}
...
export function CircleCheckIcon({ height = 24, width = 24 }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={height}
...
export function CreditCardOffIcon({ height = 24, width = 24 }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={height}
...
export function ChevronLeftIcon({ height = 24, width = 24 }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={height}
...
export function ChevronRightIcon({ height = 24, width = 24 }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={height}
...
export function MenuIcon({ height = 24, width = 24 }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={height}
...
export function XIcon({ height = 24, width = 24 }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={height}
