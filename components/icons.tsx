...
export function RocketIcon({ height = 24, width = 24, className }: IconProps) {
  return (
    <svg
...
export function DocToRightIcon({ height = 24, width = 24, className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={height}
...
export function SearchCheckIcon({ height = 24, width = 24, className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={height}
...
export function LaptopIcon({ height = 24, width = 24, className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={height}
...
export function CircleCheckIcon({ height = 24, width = 24, className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={height}
...
export function CreditCardOffIcon({ height = 24, width = 24, className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={height}
...
export function ChevronLeftIcon({ height = 24, width = 24, className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={height}
...
export function ChevronRightIcon({ height = 24, width = 24, className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={height}
...
export function MenuIcon({ height = 24, width = 24, className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={height}
...
export function XIcon({ height = 24, width = 24, className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={height}
      ...
      className={className}
    >
      <path d="m256-227-29-29 224-224-224-224 29-29 224 224 224-224 29 29-224 224 224 224-29 29-224-224-224 224Z" />
    </svg>
  );
}

export function ChevronDownIcon({ height = 24, width = 24, className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={height}
...
export function GitHubIcon({ height = 24, width = 24, className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={height}
